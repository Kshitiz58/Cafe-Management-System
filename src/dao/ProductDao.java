...
public class ProductDao {
    ...
    public static void save(Product product) {
        ...
        DbOperation.setDataOrDelete(query, "Your Product is Added Successfully!!");
    }
    ...
    public static void update(Product product) {
        ...
        DbOperation.setDataOrDelete(query, "Your Product is Updated Successfully!!");
    }

    public static void delete(String id) {
        String query = "delete from product where id = '" + id + "'";
        DbOperation.setDataOrDelete(query, "Your Product is Deleted Successfully!!");

    }

    public static ArrayList<Product> getAllRecordsByCategroy(String category) {
        ArrayList<Product> arrayList = new ArrayList<>();
        try {
